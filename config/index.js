...
module.exports = {
  dev:{
    ...
    assetsSubDirectory:'static',assetsPublicPath:'/',proxyTable:{
      '/api1':{
        target:'http://192.168.5.114:8001',changeOrigin:true,pathRewrite:{
          '^/api1':''
        }
      },'/api2':{
        target:'http://192.168.5.114:8002',changeOrigin:true,pathRewrite:{
          '^/api2':''
        }
      },'/api4':{
        target:'http://192.168.5.114:8004',changeOrigin:true,pathRewrite:{
          '^/api4':''
        }
      },secure:false
  ...
  build:{
    ...
    productionSourceMap:false, // https://webpack.js.org/configuration/devtool/#production
    devtool:'#source-map',
